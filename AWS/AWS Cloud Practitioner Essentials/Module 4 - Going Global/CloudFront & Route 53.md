CloudFront is a content delivery network, and it’s designed to serve content as close to users as possible. This content can be images, data, videos, applications, APIs, etc..
